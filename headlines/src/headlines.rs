...
use eframe::egui::{
    menu, Button, Color32, CtxRef, FontDefinitions, FontFamily, Hyperlink, Key, Label, Layout,
    Separator, TextStyle, TopBottomPanel, Ui, Window,
};
...
impl Headlines {
    pub fn new() -> Headlines {
        let config: HeadlinesConfig = confy::load("headlines_conf").unwrap_or_default();
        // dbg!(config.api_key.clone());
